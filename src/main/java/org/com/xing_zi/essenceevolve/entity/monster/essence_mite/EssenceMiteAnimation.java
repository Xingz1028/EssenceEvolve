package org.com.xing_zi.essenceevolve.entity.monster.essence_mite;// Save this class in your mod and generate all required imports
 ...
 * @author Author
 */
public class EssenceMiteAnimation {
	public static final AnimationDefinition move = AnimationDefinition.Builder.withLength(0.4583F).looping()
