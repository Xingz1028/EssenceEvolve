package org.com.xing_zi.essenceevolve.entity.projectile.ball.WindBallEntity;
...
public class WindBallEntity extends ThrowableItemProjectile {
    private int tick;
    private final float DEFAULT_ATTACK_VALUE = 6F;
    ...
    protected void onHitEntity(EntityHitResult pResult) {
        ...
        if (entity instanceof LivingEntity pLivingEntity) {
            ...
            for (LivingEntity ofClass : entitiesOfClass) {
                ofClass.hurt(ofClass.damageSources().thrown(this,this.getOwner()),attackValue);
            }
