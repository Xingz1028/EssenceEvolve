...
import org.com.xing_zi.essenceevolve.menu.HerbCauldronMenu;
...
public class HerbCauldronBlockEntity extends BlockEntity implements MenuProvider {
    ...
    private void craftFinish(HerbCauldronRecipe recipe) {
        if (level != null) {
            if (isUnderCorrectBlock()) {
                ItemStack resultItem = recipe.assemble(createRecipeContainer(),level.registryAccess()).copy();
    ...
    public @NotNull Component getDisplayName() {
        return Component.translatable("block.essenceevolve.herb_cauldron_memu");
    }
