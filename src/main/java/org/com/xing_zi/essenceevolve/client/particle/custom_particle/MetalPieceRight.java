...
@OnlyIn(Dist.CLIENT)
public class MetalPieceRight extends TextureSheetParticle {


    protected MetalPieceRight(ClientLevel pLevel, double pX, double pY, double pZ) {
...
// 粒子基础属性，在这里统一初始化
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public @Nullable Particle createParticle(SimpleParticleType pType, ClientLevel pLevel, double pX, double pY, double pZ, double pXSpeed, double pYSpeed, double pZSpeed) {
            MetalPieceRight particle = new MetalPieceRight(pLevel, pX, pY, pZ);
