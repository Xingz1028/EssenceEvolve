...
public class WaterBeneficialEffect extends MobEffect {
    public WaterBeneficialEffect() {
        super(MobEffectCategory.BENEFICIAL, 0x00e8ff);
    }
    @Override
    public void applyEffectTick(@NotNull LivingEntity pLivingEntity, int pAmplifier) {
        ...
        if (!level.isClientSide()) {
            ...
            for (int i = 0; i < particleCount; i++) {
                ...
                // 服务端标准粒子发包方法
                serverLevel.sendParticles(ParticleTypes.BUBBLE_POP, px, py, pz, 5, velX, velY, velZ, 0.0D);
            }
        }
    }
    @Override
