...
public class EarthBallRenderer extends EntityRenderer<EarthBallEntity> {
    private final EarthBallModel<EarthBallEntity> model;

    public EarthBallRenderer(EntityRendererProvider.Context pContext) {
        super(pContext);
        this.model = new EarthBallModel<>(pContext.bakeLayer(EssModelLayerRegister.EARTH_BALL_LAYER));
    }

    @Override
    public void render(EarthBallEntity fireBall, float yRot, float partialTick, PoseStack pose, MultiBufferSource buffer, int light) {
    ...
    @Override
    public ResourceLocation getTextureLocation(EarthBallEntity pEntity) {
        return ResourceLocation.fromNamespaceAndPath(Essenceevolve.MODID, "textures/entity/ball/earth_ball.png");
    }
}
