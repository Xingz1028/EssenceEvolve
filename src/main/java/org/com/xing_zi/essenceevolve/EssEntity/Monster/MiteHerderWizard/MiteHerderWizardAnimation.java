package org.com.xing_zi.essenceevolve.EssEntity.Monster.MiteHerderWizard;// Save this class in your mod and generate all required imports
 ...
 * @author Author
 */
public class MiteHerderWizardAnimation {
	public static final AnimationDefinition walk = AnimationDefinition.Builder.withLength(0.6667F).looping()
		.addAnimation("feet1", new AnimationChannel(AnimationChannel.Targets.ROTATION,
